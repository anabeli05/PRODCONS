...
// Incluir el componente de comentarios
include '/xampp/htdocs/PRODCONS/PI2do/Dashboard_Usuario/likes and comments/comments.php';

include '/xampp/htdocs/PRODCONS/PI2do/footer/Visitante/footer.php'; 
?>
