<footer class="footer">
    <div class="footer-container">
        <!-- Columna 1: Logo -->
        <img class="prodcons2" src='/PRODCONS/imagenes/prodcon/prodcons_white.png' alt="Logo" style="width:220px; height:auto; margin-left:40px; box-shadow:none; border-radius:0;">
